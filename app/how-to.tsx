...
export const HOWTO: Record<Lang, HowStep[]> = {
  ...
  ko: [
    ...
    },
    {
      ...
      body: "YouTube / X / 직접 링크를 붙이면 참조 영상이 받아집니다. 그리고 생성한 테이크는 라이브러리에 계속 쌓여서, 지난 클립을 언제든 참조로 다시 불러올 수 있어요.",
    },
    {
      icon: "⑆",
      title: "모션은 그대로, 사람만 교체",
      body: "Runway Act-Two로 참조 클립의 동작을 당신 캐릭터에 다시 연기시킵니다. 정확한 복제는 의도적으로 제한돼 있어요 — 동작·표정은 참고하되 누구의 신원도 복제하지 않습니다(당신 캐릭터가 주인공). “그 사람”이 아니라 “그 느낌의 연기”를 재현합니다.",
    },
  ],
};
